(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("axios"), require("groq-sdk"), require("openai"), require("@anthropic-ai/sdk"), require("cohere-ai"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "axios", "groq-sdk", "openai", "@anthropic-ai/sdk", "cohere-ai"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("axios"), require("groq-sdk"), require("openai"), require("@anthropic-ai/sdk"), require("cohere-ai")) : factory(root["electron-serve"], root["electron-store"], root["axios"], root["groq-sdk"], root["openai"], root["@anthropic-ai/sdk"], root["cohere-ai"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE_axios__, __WEBPACK_EXTERNAL_MODULE_groq_sdk__, __WEBPACK_EXTERNAL_MODULE_openai__, __WEBPACK_EXTERNAL_MODULE__anthropic_ai_sdk__, __WEBPACK_EXTERNAL_MODULE_cohere_ai__) => {
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__anthropic_ai_sdk__;
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_cohere_ai__;
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/parse-float */ "./node_modules/@babel/runtime-corejs3/core-js-stable/parse-float.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_date_now__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/date/now */ "./node_modules/@babel/runtime-corejs3/core-js-stable/date/now.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_date_now__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_date_now__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_set_interval__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_set_interval__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var electron_serve__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! electron-serve */ "electron-serve");
/* harmony import */ var electron_serve__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(electron_serve__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helpers */ "./main/helpers/index.js");
...
const OpenAI = (__webpack_require__(/*! openai */ "openai").OpenAI);
const Anthopic = __webpack_require__(/*! @anthropic-ai/sdk */ "@anthropic-ai/sdk");
const CohereClient = (__webpack_require__(/*! cohere-ai */ "cohere-ai").CohereClient);
const isProd = "development" === 'production';
const postInstallFlagPath = path__WEBPACK_IMPORTED_MODULE_15___default().join(electron__WEBPACK_IMPORTED_MODULE_11__.app.getPath('userData'), 'postInstallDone.flag');
let settingsWindow;
let mainWindow;
let pingOllamaSender;
if (isProd) {
  electron_serve__WEBPACK_IMPORTED_MODULE_12___default()({
    directory: 'app'
  }); // important for the build
} else {
  electron__WEBPACK_IMPORTED_MODULE_11__.app.setPath('userData', `${electron__WEBPACK_IMPORTED_MODULE_11__.app.getPath('userData')} (development)`);
}
function getParentDir(_file) {
  if (isProd) return path__WEBPACK_IMPORTED_MODULE_15___default().dirname(path__WEBPACK_IMPORTED_MODULE_15___default().dirname(path__WEBPACK_IMPORTED_MODULE_15___default().dirname(__dirname)));else return path__WEBPACK_IMPORTED_MODULE_15___default().dirname(__dirname);
}
function resolveHome(filepath) {
  return _babel_runtime_corejs3_core_js_stable_instance_starts_with__WEBPACK_IMPORTED_MODULE_0___default()(filepath).call(filepath, '~') ? path__WEBPACK_IMPORTED_MODULE_15___default().join(os.homedir(), _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_1___default()(filepath).call(filepath, 1)) : filepath;
}
...
function get_blocks(data) {
  ...
  blocks = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_2___default()(blocks).call(blocks, block => {
    if (_babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"id"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"created"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"prompt_tokens"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"total_tokens"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"object"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"index"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"choices"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"message"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"content"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"delta"') && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(block).call(block, '"}}]}') // no need to control also the start of the block, because of the split.
    ) {
      return block;
    }
  });
...
async function isUrlRunning(url) {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_14___default().get(url);
...
async function showDialog(title, message) {
  electron__WEBPACK_IMPORTED_MODULE_11__.dialog.showMessageBox(mainWindow, _options(title, message)).then(result => {
...
async function createSettingsWindow() {
  settingsWindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_13__.createWindow)('settings-window', {
    width: 750,
    height: 480,
    resizable: true,
    maximizable: false,
    ...
    frame: true,
    webPreferences: {
      preload: path__WEBPACK_IMPORTED_MODULE_15___default().join(__dirname, 'preload.js')
    }
  });
  if (isProd) {
...
async function createMainWindow() {
  mainWindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_13__.createWindow)('main-window', {
    width: 750,
    height: 480,
    // alwaysOnTop: true,
    resizable: false,
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('window-blur', e => {
    mainWindow.hide();
  });
  function get_content_block(block) {
    ...
    try {
      var _context;
      const jsonData = JSON.parse('{ "data"' + _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_1___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_4___default()(block).call(block)).call(_context, 4, -1) + "}}");
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("open-url", async (event, url) => {
    electron__WEBPACK_IMPORTED_MODULE_11__.shell.openExternal(url);
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("quit-app", async event => {
    electron__WEBPACK_IMPORTED_MODULE_11__.app.quit();
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("open-settings", async event => {
    if (!settingsWindow || settingsWindow.isDestroyed()) {
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("logger", (event, object) => {
    console.log('logger ->', object);
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("search-pplx", async (event, args) => {
    ...
    const options = {
      ...
      data: {
        ...
        max_tokens: maxTokens ? _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_5___default()(maxTokens, 10) : 500,
        temperature: temperature ? _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6___default()(temperature) : 0.75,
        stream: true
      }
    };
    let bufferData = ''; //
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_14___default().request(options);
      const start = _babel_runtime_corejs3_core_js_stable_date_now__WEBPACK_IMPORTED_MODULE_7___default()();
      ...
      stream.on('end', () => {
        const end = _babel_runtime_corejs3_core_js_stable_date_now__WEBPACK_IMPORTED_MODULE_7___default()();
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("search-groq", async (event, args) => {
    event.sender.send('search-result', " ");
    const {
      query,
      model,
    ...
    try {
      const chatCompletion = await groq.chat.completions.create({
        ...
        "temperature": temperature ? _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6___default()(temperature) : 0.5,
        "max_tokens": maxTokens ? _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_5___default()(maxTokens, 10) : 1024,
        "top_p": 1,
        "stream": true,
        "stop": null
      });
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("search-openai", async (event, args) => {
    event.sender.send('search-result', " ");
    const {
      query,
      model,
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("search-anthropic", async (event, args) => {
    event.sender.send('search-result', " ");
    const {
      query,
      model,
    ...
    try {
      const stream = await anthropic.messages.stream({
        ...
        temperature: temperature ? _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6___default()(temperature) : 1,
        max_tokens: maxTokens ? _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_5___default()(maxTokens, 10) : 1024
      });
      let bufferData = '';
      stream.on("text", text => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("search-cohere", async (event, args) => {
    event.sender.send('search-result', " ");
    const {
      query,
      model,
    ...
    try {
      const stream = await cohere.chatStream({
        ...
        message: query,
        stream: true,
        temperature: temperature ? _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_6___default()(temperature) : 0.2,
        connectors: [{
          id: "web-search"
        }],
        max_tokens: maxTokens ? _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_5___default()(maxTokens, 10) : 1024
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('warning', async (e, title, message) => {
    await showDialog(title, message);
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.globalShortcut.register('Option+X', () => {
...
(async () => {
  await electron__WEBPACK_IMPORTED_MODULE_11__.app.whenReady();
  console.log("---------------------->", fs.existsSync(postInstallFlagPath));
  if (!fs.existsSync(postInstallFlagPath)) {
    settingsWindow = await createSettingsWindow();
    const scriptPath = path__WEBPACK_IMPORTED_MODULE_15___default().join(getParentDir(), 'scripts/init.sh');
    ...
    electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('ollama-ready', () => {
      fs.writeFileSync(postInstallFlagPath, 'done');
    });
    electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('ping-ollama', async event => {
      console.log('[settings]-logger -> None');
      pingOllamaSender = event.sender;
      const intervalId = _babel_runtime_corejs3_core_js_stable_set_interval__WEBPACK_IMPORTED_MODULE_8___default()(async () => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('relaunch-hask', async event => {
    if (mainWindow) {
      var _context2, _context3;
      // quit the app and relaunch it
      mainWindow.close();
      settingsWindow.close();
      electron__WEBPACK_IMPORTED_MODULE_11__.app.relaunch({
        args: _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_9___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_1___default()(_context3 = process.argv).call(_context3, 1)).call(_context2, ['--relaunch'])
      });
      electron__WEBPACK_IMPORTED_MODULE_11__.app.exit(0);
    }
    mainWindow = await createMainWindow();
    settingsWindow = await createSettingsWindow();
    settingsWindow.show();
  ...
  const menu = electron__WEBPACK_IMPORTED_MODULE_11__.Menu.buildFromTemplate(template);
  electron__WEBPACK_IMPORTED_MODULE_11__.Menu.setApplicationMenu(menu);
  electron__WEBPACK_IMPORTED_MODULE_11__.app.dock.hide();
  electron__WEBPACK_IMPORTED_MODULE_11__.app.on('window-all-closed', () => {
    if (process.platform !== 'darwin') {
      electron__WEBPACK_IMPORTED_MODULE_11__.app.quit();
    }
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.app.on('activate', async () => {
    if (electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow.getAllWindows().length === 0) {
      mainWindow = await createMainWindow();
    }
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.app.on('before-quit', () => {
    ...
    // close every window
    const windows = electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow.getAllWindows();
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_10___default()(windows).call(windows, window => {

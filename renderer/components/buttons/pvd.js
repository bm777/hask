...
export default function Pvd({ text, action, defaultModel, selected }) {
    ...
    return (
        <div onClick={handleClick} className={"hover:bg-[#c5ccdb9a]  flex items-center justify-between mt-1 py-[8px] px-2 rounded-md transition-all duration-200 hover:cursor-default dark:text-[#93929497] " + (selected ? "bg-[#b7becbab]" : "")}>
            ...
            <div className=" flex items-center justify-center ">
                <div className="bg-[#2f2f2f1d] h-[24px] w-[24px] flex items-center justify-center rounded-md border border-[#8181814b]">

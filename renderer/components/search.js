        ...
        <div className=" h-[100vh] w-full flex flex-col relative">
            ...
            }
            {
                modelExpanded && query !== "" && (
                    <div
                        ref={modelRef}
                        className={`px-2 border border-gray-600/30 rounded-md fixed bottom-12 right-3 z-10 w-[350px] min-h-[250px] max-h-[300px] overflow-auto shadow-xl bg-light-modal shadow-black/20 dark:bg-dark-modal`}
                    >
                        <div className={`text-xs text-[#4d4e509a] font-bold mt-3 dark:text-neutral-500`}>
                            Models
                        </div>
